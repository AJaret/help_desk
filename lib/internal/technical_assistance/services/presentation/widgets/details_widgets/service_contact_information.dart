...
class ServiceContactInformationWidget extends StatelessWidget {
  final TechnicianService serviceData;
  const ServiceContactInformationWidget({super.key, required this.serviceData});
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    List<String> phoneNumbers = serviceData.phone?.split(',') ?? [];
    List<String> extensions = serviceData.phoneExtension?.split(',') ?? [];
    List<String> emails = serviceData.email?.split(',') ?? [];
